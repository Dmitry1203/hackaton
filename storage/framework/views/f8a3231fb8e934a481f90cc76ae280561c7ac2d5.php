...
<aside class="sidebar body-text-medium">
  ...
  <div class="logo">
    ...
    <a href="<?php echo e(Route('personal.index')); ?>" class="logo-link">
    <img src="/images/smolathon-logo.png" alt="SMOLATHON">
    </a>

    <br><br>

    <a href="https://www.хакатоны.рус/" class="logo-link" target="_blank">
    <img src="/images/hak-rus-logo.png" alt="хакатоны.рус">
    </a>

  </div>

</aside><?php /**PATH C:\OSPanel\domains\smolathon\resources\views/components/mainMenu.blade.php ENDPATH**/ ?>