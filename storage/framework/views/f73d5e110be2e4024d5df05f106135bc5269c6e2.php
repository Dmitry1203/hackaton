                ...
                <div class="solutions-container">
                    <div class="solutions-header">
                        <div class="solutions-header-wrapper body-text-large">
                            ...
                            <?php if($onеTime): ?>
                                <div class="status body-text-small">Решение предоставлено вовремя</div>
                            <?php else: ?>
                                <div class="status late body-text-small">Решение предоставлено с опозданием</div>
                            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\green\resources\views/personal/stageAndSolution.blade.php ENDPATH**/ ?>