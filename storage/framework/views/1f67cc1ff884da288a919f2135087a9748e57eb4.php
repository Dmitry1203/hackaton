        <aside class="menu mobile-menu">
            <div class="menu-header body-text-medium">
                <div class="logo">
                    <a href="<?php echo e(Route('organizer.index')); ?>" class="logo-link">
            ...
            <nav class="menu-nav body-text-medium">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <?php if(Route::currentRouteName() === 'organizer.index'): ?>
                    <li class="nav-item active">
                        <?php else: ?>
                    <li class="nav-item">
                        <?php endif; ?>
                        <a href="<?php echo e(Route('organizer.index')); ?>" class="nav-link">
                    ...
                    <?php if(Route::currentRouteName() === 'organizer.notifications'): ?>
                    <li class="nav-item active">
                        <?php else: ?>
                    <li class="nav-item">
                        <?php endif; ?>

                        <a href="<?php echo e(Route('organizer.notifications')); ?>" class="nav-link">
            ...
            <div class="menu-footer body-text-medium">
                <a href="<?php echo e(Route('organizer.close')); ?>" class="logout">
                    <svg class="stroke-hover" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <aside class="sidebar body-text-medium">
            <div class="panel">
                ...
                <div class="user-info">
                    <div class="user-name">"Зелёная школа"</div>
                    <div class="user-status">Организатор</div>
                </div>
            </div>
        ...
        </aside><?php /**PATH C:\OSPanel\domains\green\resources\views/components/mainOrganizerMenu.blade.php ENDPATH**/ ?>