     ...
     <?php $__env->slot('content', null, []); ?> 
        ...
        <div class="content solutions">
            <div class="content-header">
                ...
                <a href="<?php echo e(Route('personal.solutions')); ?>" class="go-back-link button button__block button__light button__medium">
                ...
                <div class="solutions-container">
                    <div class="solutions-header">
                        <div class="solutions-header-wrapper body-text-large">
                            <div class="solution-title"><?php echo e($stage[0]->stage); ?></div>
                            <div class="solution-time">
                                ...
                                До <?php echo e(_date_MM_DD_YYYY($stage[0]->stage_date_end)); ?>


                            </div>
                        </div>
                        <h5><?php echo e($stage[0]->stage_short); ?></h5>
                    </div>
                    <div class="solutions-content">
                        ...
                        <div class="solutions-content-description body-text-medium">
                            <?php echo e($stage[0]->stage_description); ?>

                        </div>
                    </div>
                    <form class="solutions-form" id="save-solution-1">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <textarea type="text" name="solution" class="form-control" id="solution"
                                    placeholder="Ваше решение" data-required="1"></textarea>
                            </div>
                        </div>
                        <div class="actions">
                            <button type="button"
         ...
         <?php echo $__env->make('personal.modal.solution', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\smolathon\resources\views/personal/stage.blade.php ENDPATH**/ ?>