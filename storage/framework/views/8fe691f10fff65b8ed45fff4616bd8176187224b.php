        <aside class="menu mobile-menu">
            ...
            <nav class="menu-nav body-text-medium">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    data-accordion="false">
                      <?php if(Route::currentRouteName() === 'sponsor.index'): ?>
                    ...
                    <?php if(Route::currentRouteName() === 'sponsor.notifications'): ?>
                        <li class="nav-item active">
                    <?php else: ?>
                        <li class="nav-item">
                    <?php endif; ?>

                        <a href="<?php echo e(Route('sponsor.notifications')); ?>" class="nav-link">
            ...
            <div class="menu-footer body-text-medium">
                <a href="<?php echo e(Route('sponsor.close')); ?>" class="logout">
                    <svg class="stroke-hover" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        </aside><?php /**PATH C:\OSPanel\domains\green\resources\views/components/mainSponsorMenu.blade.php ENDPATH**/ ?>