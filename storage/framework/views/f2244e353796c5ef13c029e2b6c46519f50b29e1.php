...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label for="work" class="body-text-large">Место работы</label>
                                    <input type="text" name="work" class="form-control" id="work" placeholder="Место работы"
                                        value="<?php echo e(auth()->user()->work); ?>">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="form-section">
                        <h5>Контакты законного представителя, если нет 18 лет</h5>
                        <div class="form-row">
                            <div class="column col">
                                <div class="form-block">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            id="parent-surname"
                                            placeholder="Фамилия"
                                            value="<?php echo e(auth()->user()->parent_surname); ?>"
                                        >
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            id="parent-name"
                                            placeholder="Имя"
                                            value="<?php echo e(auth()->user()->parent_name); ?>"
                                        >
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input
                                            type="text"
                                            name="parent-patronym"
                                            class="form-control"
                                            id="parent-patronym"
                                            placeholder="Отчество"
                                            value="<?php echo e(auth()->user()->parent_patronym); ?>"
                                        >
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            value="<?php echo e(auth()->user()->parent_phone); ?>"
                                        >
                                    </div>
                                </div>
                            </div>
...
<?php endif; ?><?php /**PATH C:\OSPanel\domains\smolathon\resources\views/personal/profileEdit.blade.php ENDPATH**/ ?>