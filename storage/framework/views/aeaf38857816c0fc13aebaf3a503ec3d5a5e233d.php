    ...
    <div class="auth-layout">
        <div class="auth-form-section">
            ...
            <?php if(!session('success') && !session('emailNotExist')): ?>
                ...
                Укажите E-mail, который был Вам выдан, или Вы указали при регистрации.
...
<?php /**PATH C:\OSPanel\domains\smolathon\resources\views/site/password.blade.php ENDPATH**/ ?>