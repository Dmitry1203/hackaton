   ...
   <?php $__env->slot('content', null, []); ?> 
        <div class="content notifications">
            <div class="content-header">
                <h3>Уведомления</h3>
                <a href="<?php echo e(Route('organizer.notifications.create')); ?>" class="button button__block button__filled button__medium">Добавить</a>
            </div>
...
<?php endif; ?><?php /**PATH C:\OSPanel\domains\green\resources\views/organizer/notifications.blade.php ENDPATH**/ ?>