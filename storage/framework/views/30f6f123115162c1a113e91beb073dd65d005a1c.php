                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="team-list">
                                ...
                                <a class="team-item user-profile-link" data-name="<?php echo e($member->name); ?>"
                                    ...
                                    data-school="<?php echo e($member->school); ?>" data-work="<?php echo e($member->work); ?>"
...
<?php $component = $__env->getContainer()->make(App\View\Components\Application::class, ['applicationId' => ''.e($application->id).'','applicationUserName' => ''.e($application->UserName).'','applicationUserSurname' => ''.e($application->UserSurname).'','applicationUserEmail' => ''.e($application->UserEmail).'','applicationUserPhone' => ''.e($application->UserPhone).'','applicationUserSchool' => ''.e($application->UserSchool).'','applicationUserWork' => ''.e($application->UserWork).'','applicationUserAbout' => ''.e($application->UserAbout).'','applicationUserAvatar' => ''.e($application->UserAvatar).'','applicationUserAge' => ''.e($application->age).'','applicationMessage' => ''.e($application->message).'','applicationDate' => ''.e($application->created_at).'']); ?>
...
<?php endif; ?><?php /**PATH C:\OSPanel\domains\smolathon\resources\views/personal/teamProfile.blade.php ENDPATH**/ ?>