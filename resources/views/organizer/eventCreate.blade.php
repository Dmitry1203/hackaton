<x-organizer-layout>
<x-slot name="title">Заполнение данных о хакатоне</x-slot>
  <x-slot name="content">
            ...
            <div class="sponsor-layout">
                <div class="sponsors-block">
                    <form
                        ...
                        name="event-form"
                        class="info-form"
                        action="{{ Route('organizer.event.store') }}"
                        method="POST"
                        autocomplete="off"
                                            ...
                                            <div class="preview-container">
                                                ...
                                                <div class="preview-item">
                                                    <button type="button" class="preview-remove"
                                                        data-target=".partner-item" data-id="1"></button>
                                                ...
                                                <div class="preview-item">
                                                    <button type="button" class="preview-remove"
                                                        data-target=".partner-item" data-id="2"></button>
                                                    <div class="preview-image">
                                                        <img src="/images/default-picture.png" alt="">
                                                    </div>
                                                </div>
