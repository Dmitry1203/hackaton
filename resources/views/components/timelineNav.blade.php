<div
    ...
    @if ($timelineComplete) complete @elseif( ($timelineNext && !$timelineComplete && $timelinePrevComplete) || ($timelineNext && !$timelineComplete && !$timelinePrevComplete)) current active @endif"
    href="#tab_{{ $timelineNumber }}"
    data-toggle="tab"
>
    ...
    <div class="timeline-info">
        <div class="timeline-text">
            ...
            <div class="timeline-description body-text-large">{!! $timelineStage !!}</div>
        </div>
