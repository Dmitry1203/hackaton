<a href="{{ Route('personal.solution', ['eventId' => $eventId, 'stageId' => $stageId]) }}" class="solution-item {{ $isLoadedSolution }}">
    <div class="solution-item-inner">
        <div class="solution-item-wrapper">
            <div class="solution-content">
                <div class="solution-title body-text-medium">{{ $stageName }}
                    @if(!empty($isLoadedSolution))<div class="status body-text-small">Решение загружено</div>@endif
                </div>
                <div class="solution-description body-text-large">{!! $stageDescriptionShort !!}</div>
