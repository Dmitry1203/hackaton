            ...
            <div class="teams-layout">
                ...
                <div class="team-widget">
                    ...
                    <div class="column">
                        <div class="team-widget-card">
                            <h6>Задача</h6>
                            <div class="body-text-medium">{{ $myTeam[0]->Task }}</div>
                        </div>
                        <div class="team-widget-card">
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="team-list">
                                ...
                                <a class="team-item user-profile-link" data-name="{{ $member->name }}"
                                    ...
                                    data-school="{{ $member->school }}" data-work="{{ $member->work }}"
                            ...
                            <div class="team-content-list">
                                ...
                                @foreach ($applications as $application)
                                    <x-application
                                        ...
                                        application-user-job-search="{{ $application->UserJobSearch }}"
                                        application-user-education="{{ $application->UserEducation }}"
                                        application-user-experience="{{ $application->UserExperience }}"
