<x-personal-layout>
    <x-slot name="title">Настройки команды</x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="content teams">
            <div class="content-header">
                ...
                <a href="{{ Route('personal.team.profile') }}" class="go-back-link button button__block button__light button__medium">
            ...
            <div class="teams-layout">
                ...
                <form id="team-form" name="team-form" class="create-team-form novalidate"
                    action="{{ Route('personal.team.update') }}" method="POST" autocomplete="off"
                            ...
                            <div class="form-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="chat" class="form-control" id="chat"
                                        placeholder="Ссылка на чат" value="{{ $team[0]->chat }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea type="text" name="description" class="form-control" id="description"
                                            ...
                                            data-required="1">{{ $team[0]->description }}</textarea>
        ...
        @include('personal.modal.teamUpdate')
