...
function sendCreateTeamForm(event, list, button) {
    let send = true;
...
document.addEventListener("DOMContentLoaded", event => {
    ...
    if (createTeamForm) {
        ...
        const submitButton = createTeamForm.querySelector('.submit-button');
        ...
        createTeamForm.addEventListener("submit", function (event) {
            sendCreateTeamForm(event, inputList, submitButton);
        })
...
$(document).ready(function() {
    ...
    saveAccountButton.click(function(e) {
        ...
        const loader = settingsForm.querySelector('.loader');
        toggleFormLoader(loader, true);

        const button = $(this);
        button.attr('disabled', true);

        openModal('#save-account', function() {
